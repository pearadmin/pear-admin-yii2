...
<body class="pear-container" style="overflow:hidden;">
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <table class="layui-table" lay-data="{url:'/rbac/rbac/get-role-list',page: true,skin:'line',height: 'full-150',limit: 10,id:'main-table',method:'post'}"lay-filter="main-table" id ='id'>
                <thead>
                    <tr>
